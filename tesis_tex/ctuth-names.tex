...
\def\ctucaptionsczech{
	...
	\def\listtablename{Lista \hspace{1pt}de \hspace{1pt}Tablas}
...
\ctusetup{
	university-endl-czech = {Universidad\\ \hspace{1cm}de \\ Buenos \hspace{2pt}Aires},
...
\seq_gset_from_clist:Nn \g_ctuthesis_Months_czech_seq { Enero, Febrero, Marzo, Abril, Mayo, Junio, Julio, Agosto, Septiembre, Octubre, Noviembre, Diciembre}
...
\keys_define:nn { ctuthesis } {
	...
	xdoctype-B .meta:n = {
		...
		doctype-czech = { Tesis ~ de ~ Licenciatura},
	...
	xfaculty-F4 .meta:n = {
		...
		faculty-czech = { Facultad ~ de ~ Ciencias ~ Exactas ~ y ~ Naturales},
		faculty-slovak = { Departamento ~ de ~ Física }
	},
	xfaculty-F5 .meta:n = {
