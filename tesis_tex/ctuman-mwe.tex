...
\vspace{1.0cm}
\todo[inline]{Definir en algún lugar qué se considera un defecto en esta parte de la óptica y ver de usar las normas vigentes}
\vspace{1.0cm}
...
\singlespacing
\section*{Defecto de superficie de un componente óptico}
\spacing{1.5}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{Figs/microespectrometro/mapespeccampuntos.png}
	\caption{Visualización en la cámara de la reflexión del filtro de la iluminación.}
	\label{fig:bgcel}
\end{figure}


No se tocó ni la cámara ni ninguna parte del setup a partir de ese momento para no perder este mapeo, a pesar de que la cámara no se encuentre perfectamente en foco, es decir que la imagen no se vea del todo nítida.
