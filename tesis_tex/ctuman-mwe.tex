...
\begin{figure}[H]
	\begin{floatrow}
		...
		\ffigbox{\includegraphics[width=7.0cm,height=7.0cm]{Figs/defectosZEISS/espectrolampZEISS.png}}{\caption{Espectro de emisión de la fuente de luz del microscopio.}\label{fig:espectrolamparazeiss}}
	\end{floatrow}
