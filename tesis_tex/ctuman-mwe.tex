...
%\usepackage[style=alphabetic, minalphanames=1, maxalphanames=1, 
%backend=biber]{biblatex}
\usepackage{subfig}
\usepackage[usenames,dvipsnames,nonamebreak]{xcolor}
...
\begin{thanks}
	...
	{\large FECHA DE INICIACN:}
	
	\bigskip
	
	{\large FECHA DE FINALIZACIN:}
