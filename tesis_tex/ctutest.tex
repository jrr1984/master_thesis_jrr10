...
%	titlelanguage = czech,
	...
	title-czech = {Caracterizacion de filtros },
...
\ctutemplateset{maketitle onecolumn default}{
	\begin{onecolumnfrontmatterpage}
		\ctutemplate{onecolumn.thanks}
		\ctutemplate{onecolumn.declaration}
		\ctutemplate{onecolumn.abstract.in.titlelanguage}
		%\ctutemplate{twocolumn.abs%tract.in.secondlanguage}
		\ctutemplate{twocolumn.tableofcontents}
		\ctutemplate{twocolumn.listoffigures}
	\end{onecolumnfrontmatterpage}
}
