...
\begin{thanks}
	...
	\textsc{TEMA:} Construcción e implementación de un sistema integral de caracterización de filtros
	 ...
	 \hspace{1.6cm}ópticos utilizados en cámaras multiespectrales satelitales.
	...
	\textsc{FECHA DE FINALIZACIÓN:} 17 de Mayo de 2020
...
filtros resulta fundamental para garantizar la calidad óptica de las imágenes 
capturadas. 
