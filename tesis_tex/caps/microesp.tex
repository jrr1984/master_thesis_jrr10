...
\begin{figure}[H]
	\centering
	\includegraphics[scale=1.0]{Figs/microespectrometro/espectro_nirt.png}
	\caption{Espectro de transmisión de la banda NIR. Tiempo de integración de la luz: 10 ms.}
	\label{fig:bnir}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=1.0]{Figs/microespectrometro/espectro_rojat.png}
...
\end{figure}
 ...
 \begin{figure}[H]
	\centering
	\includegraphics[scale=1.0]{Figs/microespectrometro/4bandas_conimshowT.png}
