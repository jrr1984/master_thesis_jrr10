...
\end{figure}
 ...
 \begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{Figs/microespectrometro/imagenagj.jpg}
...
%En la Figura \ref{} se muestra un barrido lineal realizado que atravesó el agujero (corroborado con la adquisición en vivo con la cámara).
