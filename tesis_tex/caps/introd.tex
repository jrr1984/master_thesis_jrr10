...
\begin{figure}[H]
	\begin{floatrow}
		\ffigbox{\includegraphics[width=0.5\textwidth]{Figs/introduccion/nasaluna7_0.jpg}}{\caption{La primera fotografía en color de todo el planeta Tierra, satélite ATS 3 (10 de noviembre de 1967) \cite{nattierrra}.}\label{fig:tiercol}}
		\ffigbox{\includegraphics[width=0.5\textwidth,height=6.9cm]{Figs/introduccion/arbolsat.png}}{\caption{Imagen multiespectral de 1 metro de resolución adquirida con una cámara a bordo de uno de los satélites de la compañía Satellogic \cite{imsatt}.}\label{fig:sat2}}
	\end{floatrow}
\end{figure}
...
\begin{figure}[H]
	...
	atraviesan el filtro y son detectadas por el sensor. Adaptado de \cite{Martinez2008}}	\label{fig:camsens}}
		\ffigbox{\includegraphics[width=0.5\textwidth]{Figs/introduccion/teled.png}}{\caption{Filtro de cinco bandas montado directamente sobre el sensor CCD, es decir en el plano focal del mismo \cite{sensarrib}.}\label{fig:se2}}
	\end{floatrow}
\end{figure}
