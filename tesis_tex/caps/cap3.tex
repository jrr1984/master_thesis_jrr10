...
\vspace{1cm}
\todo[inline]{Eventualmente esto va en la introd?}
\vspace{1cm}
...
\end{itemize}
 ...
 \vspace{1cm}
\todo[inline]{ver de explicar para qué sirve cada banda, usar por ej: \href{http://gspperu.com/pdf/res_landsat7etm.pdf}{link}}
\vspace{1cm}
...
\end{figure}
La cámara monocromática del microscopio del fabricante Zeiss, modelo Axiocam 702, con un sensor CMOS de 1/1.2'' (diagonal de 13.3mm) y 2.3 megapíxeles, fue controlada a través del software ZEN 2.5 (Blue edition, 2018) del mismo fabricante. Se utilizó la calibración de la cámara que viene de fábrica del microscopio, donde las medidas de 1 píxel son de a 0.586 $\mu m$ x 0.586 $\mu m$. \todo{esta calibración hecha por la gente de zeiss es infinitamente mejor que la pueda hacer con una reglita y el FIJI..}
