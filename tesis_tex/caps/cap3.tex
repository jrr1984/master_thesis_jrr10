...
Pancromática& 1 & $(51 \pm 1)\mu m$ & $(51 \pm 1)\mu m$  \\
...
\begin{center}
\begin{tabular}{ |c|c|c|c| }    \toprule
\texttt{Banda} & \texttt{\# de defectos} & \texttt{$d_{máx}$} & \texttt{$Área_{defectos}$}\\\midrule
\rowcolor{blue!15} Azul    & 115 & $(81 \pm 6)\mu m$ & $(71488 \pm 583)\mu m^{2}$   \\ 
\rowcolor{green!50} Verde  & 42 &  $(35 \pm 2)\mu m$ &  $(18117 \pm 248) \mu m^{2}$\\ 
Pancromática& 65 & $(51 \pm 1)\mu m$ & $(28786 \pm 61)\mu m^{2}$  \\
...
En la Tabla \ref{} se muestran algunos resultados representativos y cuantitativos de la población de defectos en general incluyendo a los agujeros.
...
La Tabla \ref{tabpobb} podría ser incluida en una hoja de datos del componente generada por parte del usuario del filtro y que podría determinar bajo algún criterio a desarrollar si el filtro supera las especificaciones de calidad propias de la aplicación
