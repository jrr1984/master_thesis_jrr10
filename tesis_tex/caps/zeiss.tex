...
\hfill%
\hfill%
\caption{(a) Imagen de fondo con una iluminación uniforme ideal, sin problemas de \textit{vignetting} y sin ruido de Poisson de fotones. (b) Histograma de la intensidad de los píxeles de la imagen de fondo ideal.}
\label{fig:fon}
\end{figure}
