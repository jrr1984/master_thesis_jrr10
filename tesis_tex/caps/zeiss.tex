...
\end{equation*}
donde \textit{Imagen de Fondo Pesada (i,j)} (Ver Imagen \texttt{d)}) e \textit{Imagen Original Pesada (i,j)} (Ver imagen \texttt{c)}) son la imagen de fondo y la imagen individual pesadas con la contribución del valor medio de la imagen correspondiente.
