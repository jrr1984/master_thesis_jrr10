...
\ctusetup{
	university-endl-czech = {Universidad \\ de \\ Buenos ~ Aires},
...
\seq_gset_from_clist:Nn \g_ctuthesis_Months_czech_seq { Leden, \'Unor, B\v rezen, Duben, Kv\v eten, \v Cerven,
	\v Cervenec, Srpen, Z\'a\v r\'i , \v R\'i jen, Listopad, Diciembre } %% ACA VAN LOS MESE DE LA CARAATULAAA
...
\keys_define:nn { ctuthesis } {
	...
	xdoctype-B .meta:n = {
		doctype-english = { Tesis de Licenciatura},
...
xfaculty-KU .meta:n = {
	...
	xfaculty-FCEyN .meta:n = {
		faculty-english = { Facultad ~ de ~ Ciencias ~ Exactas ~ y ~ Naturales},
